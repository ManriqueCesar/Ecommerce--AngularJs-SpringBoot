...
public interface IFacturaDao extends CrudRepository<Factura, Long>{
	...
	@Query("select new com.eCommerce.springboot.app.model.FacturaModelo(c) from Factura c")
	public List<FacturaModelo> findAllFacturas();
	
	@Query("select new com.eCommerce.springboot.app.model.FacturaModelo(f) from Factura f where f.id=:id")
